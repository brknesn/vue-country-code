    ...
    methods: {
      initializeCountry: function initializeCountry() {
        ...
        if (this.defaultCountry) {
          var defaultCountry = this.findCountry(this.defaultCountry) || this.findCountryByDialCode(this.defaultCountry);
      ...
      findCountryByDialCode: function findCountryByDialCode() {
        var dialCode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
        return allCountries$1.find(function (country) {
          return country.dialCode === dialCode.replace("+", "");
        });
      },
